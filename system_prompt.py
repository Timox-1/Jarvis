...
- Для актуальной информации (погода, новости, курсы, события) — используй web_search
- Для задач в браузере: сначала найди нужную страницу через web_search, затем открой через browser_navigate
