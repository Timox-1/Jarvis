...
ONBOARDING = (
    ...
    "Умею:\n"
    "• задачи, напоминания, утренний брифинг\n"
    "• Яндекс Календарь и почту\n"
    "• заметки, контакты, учёт расходов\n"
    "• голос, фото, браузер\n\n"
    "Просто напиши, что нужно. Голосовые тоже ок.\n\n"
    "Команды: /status — сводка дня, /clear — очистить историю."
)
